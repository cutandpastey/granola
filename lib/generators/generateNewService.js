...
var generateNewCollection = require('./generateNewCollection');
...
module.exports = function(args, filter){
  ...
  var serviceOutput = path.resolve(outputPath, name + 'Service.js');

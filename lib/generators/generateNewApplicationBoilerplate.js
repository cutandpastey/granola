...
module.exports = function(filepath, name, production, verbose){
		...
		var getTemplatePath = path.resolve(__dirname, '../templates/services-core/get.js.tmpl');
		var getPath = filepath + '/services/core/get.js';
		renderTemplate(getTemplatePath, getPath);
		print('green', 'Written %s ', getPath);

		//make services/core/get
		var putTemplatePath = path.resolve(__dirname, '../templates/services-core/put.js.tmpl');
		var putPath = filepath + '/services/core/put.js';
		renderTemplate(putTemplatePath, putPath);
		print('green', 'Written %s ', putPath);

		//make services/core/get
		var postTemplatePath = path.resolve(__dirname, '../templates/services-core/post.js.tmpl');
		var postPath = filepath + '/services/core/post.js';
		renderTemplate(postTemplatePath, postPath);
		print('green', 'Written %s ', postPath);

		//make services/core/get
		var deleteTemplatePath = path.resolve(__dirname, '../templates/services-core/delete.js.tmpl');
		var deletePath = filepath + '/services/core/delete.js';
		renderTemplate(deleteTemplatePath, deletePath);
		print('green', 'Written %s ', deletePath);
